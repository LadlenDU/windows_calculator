...
if( boombox_is_plugin_active('boombox-theme-extensions/boombox-theme-extensions.php') && boombox_reactions_is_enabled()){
...
function boombox_init_reaction_settings( $reaction_settings ) {
	...
	$award_minimal_score = absint( boombox_get_theme_option( 'settings_reaction_award_minimal_score' ) );
...
function boombox_init_reaction_restrictions( $vote_restrictions ) {
	// total
	$signed_in_restrict = boombox_get_theme_option( 'settings_rating_points_login_require' );
	$maximal_count_per_vote = absint( boombox_get_theme_option( 'settings_reactions_maximal_count_per_vote' ) );
