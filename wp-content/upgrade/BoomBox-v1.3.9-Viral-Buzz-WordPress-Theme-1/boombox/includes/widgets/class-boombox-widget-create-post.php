...
if ( ! class_exists( 'Boombox_Widget_Create_Post' ) ) {
	...
	class Boombox_Widget_Create_Post extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			$auth_is_disabled = boombox_disabled_site_auth();
			if ( ! $auth_is_disabled ) :
				...
				echo boombox_get_create_post_button( array( 'bb-btn', 'btn-create', 'bb-btn-primary' ), $button_text, $button_enable_plus_icon, $button_link );
