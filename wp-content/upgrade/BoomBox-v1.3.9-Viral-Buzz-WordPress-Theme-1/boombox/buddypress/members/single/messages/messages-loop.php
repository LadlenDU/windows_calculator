		...
		<table id="message-threads" class="messages-notices bbp-table-responsive">
			...
			<thead>
				<tr>
                    ...
                    <?php endif; ?>
					<th scope="col" class="thread-from" colspan="2"><?php _e( 'From', 'buddypress' ); ?></th>
				...
				<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
					...
					<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
						<td class="bulk-select-check">
							<label class="bbp-checkbox" for="bp-message-thread-<?php bp_message_thread_id(); ?>">
						...
						<?php if ( 'sentbox' != bp_current_action() ) : ?>
							...
							<td class="thread-from">
                                ...
                                <strong><?php bp_message_thread_from(); ?></strong>
						...
						<?php else: ?>
							...
							<td class="thread-from">
                                <span class="to"><?php _e( 'To:', 'buddypress' ); ?></span>
                                <strong><?php bp_message_thread_to(); ?></strong>
                                <span class="activity"><?php bp_message_thread_last_post_date(); ?></span>
							</td>
						<?php endif; ?>
