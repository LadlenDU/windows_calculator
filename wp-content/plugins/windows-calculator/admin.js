jQuery(function ($) {
    ...
    $(".wnd_calc_wnd_option_add_window").click(function (e) {
        ...
        newRow += '<table style="width:90%;float:right;">'
            ...
            + '<tr>'
            + '<th>'
            + 'Ширина:<br><input class="name_wnd_option_short" type="text" value="" name="plugin_options_wnd_calc[window][panes][' + key + '][width][]">'
            + '<input type="checkbox" class="mod_wnd_option_name" title="Редактировать" checked="checked">'
            + '</th>'
            + '<th>'
            + 'Мин. ширина:<br><input class="name_wnd_option_short" type="text" value="" name="plugin_options_wnd_calc[window][panes][' + key + '][width-min][]">'
            + '<input type="checkbox" class="mod_wnd_option_name" title="Редактировать" checked="checked">'
            + '</th>'
            + '<th>'
            + 'Макс. ширина:<br><input class="name_wnd_option_short" type="text" value="" name="plugin_options_wnd_calc[window][panes][' + key + '][width-max][]">'
            + '<input type="checkbox" class="mod_wnd_option_name" title="Редактировать" checked="checked">'
            + '</th>'
